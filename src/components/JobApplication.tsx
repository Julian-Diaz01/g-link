    ...
    <div className={`max-w-6xl mx-auto p-8 ${className}`}>
      <div className="p-2 border-b border-gray-700">
        ...
        <p className="text-gray-300 text-lg">
          Upload your CV and job details to generate a personalized cover letter
        </p>
      </div>
      ...
      {currentJob && (
        <div className="mt-8 p-8 bg-gradient-to-r from-blue-900 to-indigo-900 border border-blue-700 rounded-xl">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-700">
              <span className="text-sm font-medium text-gray-300">
                Job ID:{' '}
                <span className="font-mono text-white">{currentJob.jobId}</span>
              </span>
              <span
      ...
      {/* Job Submission Form */}
      <div className="mt-8 p-8 bg-gray-700 rounded-xl">
        <h2 className="text-xl font-semibold text-white mb-6 flex items-center">
          <svg
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-600">
            ...
            <div className="relative">
              <input
                ...
                className="block w-full text-sm text-gray-300 file:mr-4 file:py-3 file:px-6 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-[#0a1930] file:text-[#f5c422] file:border-[#f5c422] file:border-1 rounded-lg p-3 bg-gray-700 focus:outline-none focus:ring-2 focus:ring-[#f5c422] focus:border-transparent"
                required
              />
            </div>
            {cvFile && (
